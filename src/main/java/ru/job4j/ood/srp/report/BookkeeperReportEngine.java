...
public class BookkeeperReportEngine implements Report {
    private final Store store;
    private final DateTimeParser<Calendar> dateTimeParser;
    private final InMemoryCurrencyConverter inMemoryCurrencyConverter;

    public BookkeeperReportEngine(Store store, DateTimeParser<Calendar> dateTimeParser, InMemoryCurrencyConverter inMemoryCurrencyConverter) {
        this.store = store;
