...
insert into universities(u_name)
values ('U1');
insert into universities(u_name)
values ('U2');
insert into universities(u_name)
...
insert into students(student_name, course, budget, speciality, enroll_date, university_id)
...
select student_name, course, speciality from students;
select course from students where course !=2;
select * from students where student_name is not null;
select * from students where enroll_date > '01.09.2018';
select * from students where student_name like '%C' AND (course > 4 OR speciality = 'S1');
select current_date;
select current_date > '01.01.2024';
select current_date + interval '12 day 1 hour 1 minute';
select student_name, course, speciality from students order by course desc;
select student_name, course, speciality from students limit 3;
